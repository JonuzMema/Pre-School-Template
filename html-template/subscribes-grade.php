            ...
            <div id="sidebar-menu" class="sidebar-menu">
               ...
               <li class="menu-title">
                     ...
                     <li class="submenu active">
                                ...
                                <ul>
                                    <li><a href="subscribes-grade.php" class="active">Subscribe List</a></li>
                                </ul>
                            </li>
                  <?php } ?>
                                 ...
                                 ?>
                                       <tr>
                                          ...
                                          <td>
                                             ...
                                             <a href="edit-subscribe-grade.php?id=<?php echo $product['id']; ?>" class="btn btn-sm bg-success-light ">
                                                <i class="fas fa-pen"></i>
                                             </a>
                                             <?php if ($user['role'] == 'Admin') { ?>
                                                <a href="subscribes-grade.php?subscribe_id=<?php echo $product['id']; ?>" class="btn btn-sm bg-danger-light " onClick="return confirm('Do you really want to delete');">
                                                   <i class="fa fa-trash"></i></a>
                                             <?php } ?>
                                             <a href="subscribe-details-grade.php?subscribe=<?php echo $product['id']; ?>" class="btn btn-info btn-sm"><i class="fa fa-info-circle" aria-hidden="true"></i></a>
                                          </td>
                                       </tr>
                                 <?php
                                    }
