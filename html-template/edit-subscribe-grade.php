            ...
            <div class="content container-fluid">
                ...
                <div class="page-header">
                    <div class="row align-items-center">
                        <div class="col">
                            <h3 class="page-title">Edit Subscibe Grade</h3>
                            <ul class="breadcrumb">
                                <li class="breadcrumb-item"><a href="subscribe.php">Subscibe Grade</a></li>
                                <li class="breadcrumb-item active">Edit Subscibe Grade</li>
                            </ul>
                        </div>
                    </div>
                </div>
                ...
                <?php
      if (isset($_POST['subscribe_update_grade'])) {
        ...
        $sql = "select * from course where name = '".$_POST['course']."'";
         ...
         $sql = "UPDATE student_course SET  grade = '" . $_POST['grade'] . "' 
                        ...
                        <div class="card">
                            ...
                            <div class="row">
                                ...
                                <div class="col-12 col-sm-6">
                                    ...
                                    <div class="col-12">
                                    <button type="submit" class="btn btn-primary" name="subscribe_update_grade">Edit Subscribe Grade</button>
                                    </div>
                                </form>
                            </div>
                            <?php
