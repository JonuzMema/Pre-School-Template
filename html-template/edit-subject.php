...
<body>
        ...
        <div class="page-wrapper">
            <div class="content container-fluid">
                ...
                if (isset($_POST['subject_update'])) {
                    $sql = "UPDATE course SET name= '" . $_POST['name'] . "',description = '" . $_POST['description'] . "',status = '" . $_POST['status'] . "', price = '" . $_POST['price'] . "' 
    ...
    <?php
    if (isset($_GET['id'])) {
        $sql = "select * from course where id = " . (int)$_GET['id'];
        $result = mysqli_query($conn, $sql);
                                ...
                                <div class="row">
                                    ...
                                    <form method="POST" class="col-md-6">
                                        ...
                                        <div class="col-12 col-sm-6">
                                            <div class="form-group">
                                                <label>Gender</label>
                                                <select class="form-control" name="status" value="<?php echo $product['status']; ?>">
                                                    <option>In Process</option>
                                                    <option>Ready</option>
                                                    <option>Finisshed</option>
                                                </select>
                                            </div>
                                        </div>
                                        ...
                                        <div class="col-12">
                                            <button type="submit" class="btn btn-primary" name="subject_update">Edit Teacher</button>
                                        </div>
                                    </form>
                                </div>
                        <?php
